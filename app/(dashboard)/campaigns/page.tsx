    ...
    <div className="space-y-6">
      ...
      {automations.length === 0 && (
        <div className="panel rounded p-8 text-center sm:p-12">
          <h3 className="text-lg font-semibold mb-2">Кампаний пока нет</h3>
          <p className="text-sm text-muted mb-6 max-w-sm mx-auto">
            Создайте первую кампанию «комментарий → Direct», и публикация или Reels превратятся в измеримый поток диалогов.
          </p>
          <Link
            href="/campaigns/new"
            ...
            <div className="flex flex-wrap items-start gap-x-4 gap-y-3">
              ...
              <div className="min-w-[12rem] flex-1">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-3 text-xs text-zinc-500">
                  <span className="font-medium text-foreground">
                    {auto._count.dmLogs}{" "}
                    {pluralRu(auto._count.dmLogs, ["запуск", "запуска", "запусков"])}
                  </span>
                  <span>·</span>
                  <span className="font-medium text-foreground">
                  ...
                  <span>·</span>
                  <span>{auto.analytics.sent} отправлено</span>
                  <span>·</span>
                  <span>{auto.analytics.skipped} пропущено</span>
                  <span>·</span>
                  <span>{auto.analytics.failed} с ошибкой</span>
                  <span>·</span>
                  <span>
                    {auto.analytics.clicks}{" "}
                    {pluralRu(auto.analytics.clicks, ["переход", "перехода", "переходов"])}
                  </span>
                </div>
              ...
              >
                ...
                {auto.postUrl && (
                  ...
                  >
                    {copiedId === auto.id ? "Скопировано!" : "Копировать ссылку"}
                  </button>
                )}
                {/* Toggle */}
                <button
